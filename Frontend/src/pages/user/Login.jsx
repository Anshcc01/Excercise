...
const Login = () => {
    ...
    const handleSubmit = e => {
        ...
        const formData = Object.formEnteries(data)
        ...
        <div className='mx-auto max-w-lg mb-e mt-6 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8'>
            <form className='space-y-4'>
                ...
                <div>
                    ...
                    <button type='submit' onClick={() => handleSubmit()} className='block w-full rounded-lg bg-secondary px-5 py-3 text-sm font-medium text-white'>Sign In</button>
